...
BASE_URL = "https://www.sgammo.com/catalog/pistol-ammo-sale/9mm-luger-ammo"
...
def scrape():
    print(f"[{datetime.now()}] Starting SGAmmo scraper...")
    ...
    with sync_playwright() as p:
        ...
        for row in rows:
            try:
                ...
                # Get per-round price from parentheses e.g. ($0.27 Per Round)
                ...
                # Get total price - first dollar amount
